...
compression-ts/          Experimental prompt compression — compress the context, keep the scaffolding (TS)
compression-python/      Experimental prompt compression — the Python mirror
