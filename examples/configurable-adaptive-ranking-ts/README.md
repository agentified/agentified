...
A. collecting — Ratel records; the graph is scored after each turn
  ...
  turn 1  clusters=1 support=1/3 obs=1 fromBaseline=1
  turn 2  clusters=1 support=2/3 obs=2 fromBaseline=2
  turn 3  clusters=1 support=3/3 obs=3 fromBaseline=3
  turn 4  "why is the build broken" -> docker_build   SKIPPED (unsuccessful)
  turn 5  clusters=2 support=3/3, 1/3 obs=4 fromBaseline=4
