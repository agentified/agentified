...
Its Cloud attach integration follows register-up/attach-down ownership: local registration syncs
definitions up, while Cloud-authored Retrieval descriptions apply down only with
`useCloudDefinitions: true`. See the TypeScript SDK README for the attach example and shadowing
rules.
