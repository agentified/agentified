...
impl ToolRegistry {
    ...
    pub fn register(&self, tool: Tool) -> napi::Result<()> {
        ...
        registry.register(core::Tool {
            ...
            searchable_description: tool.searchable_description,
...
fn core_fact(fact: Fact) -> napi::Result<core::Fact> {
    ...
    Ok(core::Fact {
        ...
        searchable_description: fact.searchable_description,
...
impl SkillRegistry {
    ...
    pub fn register(&self, skill: Skill) -> napi::Result<()> {
        ...
        registry.register(core::Skill {
            ...
            searchable_description: skill.searchable_description,
