...
- Opt-in Cloud-owned Retrieval descriptions through runtime attach: the runtime catalog applies complete overlays without losing local definitions, restores local values on clear, and warns when Cloud shadows an explicit local value.
