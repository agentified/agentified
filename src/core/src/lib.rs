...
pub use trace::{
    ChurnKind, EmbedderLoadStatus, FactHitTrace, FactInjectReason, FnSink, JsonlSink, MemorySink,
    NoopSink, Origin, SearchHitTrace, SearchStage, SkillHitTrace, TraceEnvelope, TraceEvent,
    TraceSink,
};
